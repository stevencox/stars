...
def kazoo ():
    ...
    #zk = KazooClient(hosts='zk://stars-dc0.edc.renci.org:2181,stars-dc1.edc.renci.org:2181,stars-dc2.edc.renci.org:2181')
    zk = KazooClient(hosts='stars-dc0.edc.renci.org:2181,stars-dc1.edc.renci.org:2181,stars-dc2.edc.renci.org:2181')
    zk.start ()
    zk.delete("/chronos/state", recursive=True)
    children = zk.get_children("/chronos")
